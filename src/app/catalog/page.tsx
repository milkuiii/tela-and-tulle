...
export default function CatalogPage() {
  ...
  return (
    <div className="space-y-8 pb-16">
      {/* Hero Header Banner */}
      <section className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-r from-[#FFEEEE] via-[#FFD6DA] to-[#F4F7CD] border border-[#FFB5BD]/40 p-5 sm:p-8 lg:p-12 shadow-glass">
